class ProvincesController < ApplicationController
  ...
  before_action :load_business, only: [:show, :index, :new, :edit, :update, :create, :destroy]
  # GET /provinces
  # GET /provinces.json
  def index
  ...
  def create
    ...
    respond_to do |format|
      if @province.save
        format.html { redirect_to '/provinces/new', notice: 'Province was successfully created.' }
