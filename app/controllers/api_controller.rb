class ApiController < ApplicationController
  ...
  def paginated_products
    ...
    if !@category.blank? || !@subcategory.blank?
      @products = @business.products.joins(:categories).where(categories: {id: [@category, @subcategory]}).order(&:created_at).reverse!.distinct.paginate(:page => params[:page], :per_page => params[:per_page])
    else
