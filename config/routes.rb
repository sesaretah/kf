Rails.application.routes.draw do
  ...
  match "/api/order_statuses" => "api#order_statuses", :via => :get

  match "/api/change_order_status" => "api#change_order_status", :via => :post
  ...
  match "/api/edit_profile" => "api#edit_profile", :via => :post
