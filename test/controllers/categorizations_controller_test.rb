...
class CategorizationsControllerTest < ActionController::TestCase
  ...
  test "should create categorization" do
    assert_difference('Categorization.count') do
      post :create, categorization: { category_id: @categorization.category_id, level: @categorization.level, product_id: @categorization.product_id }
    end
  ...
  test "should update categorization" do
    patch :update, id: @categorization, categorization: { category_id: @categorization.category_id, level: @categorization.level, product_id: @categorization.product_id }
    assert_redirected_to categorization_path(assigns(:categorization))
  end
