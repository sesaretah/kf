...
class FaqsControllerTest < ActionController::TestCase
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post :create, faq: { answer: @faq.answer, business_id: @faq.business_id, question: @faq.question, rank: @faq.rank }
    end
  ...
  test "should update faq" do
    patch :update, id: @faq, faq: { answer: @faq.answer, business_id: @faq.business_id, question: @faq.question, rank: @faq.rank }
    assert_redirected_to faq_path(assigns(:faq))
  end
