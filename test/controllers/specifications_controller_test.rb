...
class SpecificationsControllerTest < ActionController::TestCase
  ...
  test "should create specification" do
    assert_difference('Specification.count') do
      post :create, specification: { product_id: @specification.product_id, spec_id: @specification.spec_id, spec_value: @specification.spec_value }
    end
  ...
  test "should update specification" do
    patch :update, id: @specification, specification: { product_id: @specification.product_id, spec_id: @specification.spec_id, spec_value: @specification.spec_value }
    assert_redirected_to specification_path(assigns(:specification))
  end
